...
public class ProcedimientoPasoExamenDAOTest {
    ...
    List<ProcedimientoPasoExamen> LISTA_REGISTROS;

    
    public ProcedimientoPasoExamenDAOTest() {
           LISTA_REGISTROS = new ArrayList<>();
        LISTA_REGISTROS.add(new ProcedimientoPasoExamen(UUID.randomUUID()));
  ...
  @Test
    public void testFindRange() {
        ...
        Mockito.when(mockEM.createNamedQuery("ProcedimientoPasoExamen.findAll", ProcedimientoPasoExamen.class)).thenReturn(mockTQ);
        ProcedimientoPasoExamenDAO cut = new ProcedimientoPasoExamenDAO();
        cut.em = mockEM;
        List<ProcedimientoPasoExamen> resultado = cut.findRange(first, max);
